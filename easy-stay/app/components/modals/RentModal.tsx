...
const RentModal = () => {
    ...
    if(step===STEPS.INFO){
        bodyContent = (
            <div className='flex flex-col gap-8'>
                ...
                <Counter 
                    title='Guests' 
                    subtitle='How many guests will stay?'
                    value= {guestCount}
        ...
        bodyContent=(
            <div className='flex flex-col gap-8'>
                <Heading
                    ...
                    subtitle='Let guests see your space!'
                />
                <ImageUpload
                    value={imageSrc}
    ...
    if(step===STEPS.DESCRIPTION){
        bodyContent=(
            <div className='flex flex-col gap-8'>
                <Heading
                    title='Tell Us About Your Space'
                    subtitle='Keep it brief and appealing!'
                />
                <Input
                    id='title'
                    label='Title'
    ...
    if(step===STEPS.PRICE){
        bodyContent = (
            <div className='flex flex-col gap-8'>
                <Heading
                    title='Price Your Stay'
                    subtitle='Determine Your Price Per Night'
                />
                <Input
                    id='price'
                    label='Price'
